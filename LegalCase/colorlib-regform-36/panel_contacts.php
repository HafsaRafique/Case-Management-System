...
$sql = "SELECT c.lawyerID, l.Name AS lawyer_name, c.courtID, a.caseID, c.casestatus, a.clientID, cl.FullName AS client_name
        FROM contacts c
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo '<td class="contacts-column">' . $row["casestatus"] . '</td>';
        echo '</tr>';
    }
    echo '</table>';
} else {
