...
// SQL query to fetch data from the "Client" table
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo '<tr>';
        echo '<td class="client-column">' . $row["clientID"] . '</td>';
        echo '<td class="client-column">' . $row["FullName"] . '</td>';
        echo '<td class="client-column">' . $row["Address"] . '</td>';
        echo '<td class="client-column">' . $row["State"] . '</td>';
        echo '<td class="client-column">' . $row["City"] . '</td>';
        echo '<td class="client-column">' . $row["Telephone"] . '</td>';
        echo '<td class="client-column">' . $row["Zipcode"] . '</td>';
        echo '<td class="client-column">' . $row["DOB"] . '</td>';
		echo '<td>';
		echo '<button class="update-button" onclick="openForm()">Update</button>';
        echo '<button class="delete-button" onclick="confirmDelete(' . $row["clientID"] . ')">Delete</button>';
        echo '</td>';
        echo '</tr>';
    }
    echo '</table>';
