...
// SQL query to fetch data from the "assignment" table with joins to retrieve additional information
$sql = "SELECT a.lawyerID, l.Name AS lawyer_name, a.clientID, cl.FullName AS client_name, a.caseID, a.billinghours
        FROM assignment a
        LEFT JOIN client cl ON a.clientID = cl.clientID
        LEFT JOIN lawyer l ON a.lawyerID = l.lawyerID";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo '<td class="contacts-column">' . $row["billinghours"] . '</td>';
        echo '</tr>';
    }
    echo '</table>';
} else {
